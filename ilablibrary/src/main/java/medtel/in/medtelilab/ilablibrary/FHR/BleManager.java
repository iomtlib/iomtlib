...
import medtel.in.medtelilab.ilablibrary.FHR.bluetooth.BleBluetooth;
import medtel.in.medtelilab.ilablibrary.FHR.bluetooth.MultipleBluetoothController;
import medtel.in.medtelilab.ilablibrary.FHR.bluetooth.SplitWriter;
import medtel.in.medtelilab.ilablibrary.FHR.callback.BleGattCallback;
import medtel.in.medtelilab.ilablibrary.FHR.callback.BleIndicateCallback;
import medtel.in.medtelilab.ilablibrary.FHR.callback.BleMtuChangedCallback;
import medtel.in.medtelilab.ilablibrary.FHR.callback.BleNotifyCallback;
import medtel.in.medtelilab.ilablibrary.FHR.callback.BleReadCallback;
import medtel.in.medtelilab.ilablibrary.FHR.callback.BleRssiCallback;
import medtel.in.medtelilab.ilablibrary.FHR.callback.BleScanAndConnectCallback;
import medtel.in.medtelilab.ilablibrary.FHR.callback.BleScanCallback;
import medtel.in.medtelilab.ilablibrary.FHR.callback.BleWriteCallback;
import medtel.in.medtelilab.ilablibrary.FHR.data.BleDevice;
import medtel.in.medtelilab.ilablibrary.FHR.data.BleScanState;
import medtel.in.medtelilab.ilablibrary.FHR.exception.OtherException;
import medtel.in.medtelilab.ilablibrary.FHR.scan.BleScanRuleConfig;
import medtel.in.medtelilab.ilablibrary.FHR.scan.BleScanner;
import medtel.in.medtelilab.ilablibrary.FHR.utils.BleLog;
...
public class BleManager {
    ...
    private static final int DEFAULT_CONNECT_RETRY_INTERVAL =2000;
    private static final int DEFAULT_MTU = 23;
    private static final int DEFAULT_MAX_MTU = 512;
    private static final int DEFAULT_WRITE_DATA_SPLIT_COUNT = 20;
    private static final int DEFAULT_CONNECT_OVER_TIME = 30000;
